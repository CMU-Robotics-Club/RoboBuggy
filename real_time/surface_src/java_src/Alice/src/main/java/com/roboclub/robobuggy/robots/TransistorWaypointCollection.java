 ...
 */
public final class TransistorWaypointCollection extends AbstractRobot {
    private static TransistorWaypointCollection instance;
    ...
    public static AbstractRobot getInstance() {
        if (instance == null) {
            instance = new TransistorWaypointCollection();
        }
        return instance;
    }

    private TransistorWaypointCollection() {
        super();
        try {
        ...
        mainWindow.addWindowListener(new WindowListener() {
            ...
            public void windowClosing(WindowEvent e) {
                // TODO Auto-generated method stub
                TransistorWaypointCollection.this.shutDown();
            }
