...
//		mostRecentUpdateTime = startTime;
        ...
        new Subscriber("HighTrustGpsLoc",NodeChannel.IMU_ANG_POS.getMsgPath(), (new MessageListener() {
			@Override
			public synchronized void actionPerformed(String topicName, Message m) {
				...
				KfLocalizer.this.updateStep(new Matrix(observationModel), new Matrix(meassurement), new Matrix(updateCovariance));
