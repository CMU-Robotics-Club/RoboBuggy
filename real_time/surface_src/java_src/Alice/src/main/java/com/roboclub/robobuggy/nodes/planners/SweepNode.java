...
public class SweepNode extends PathPlannerNode {
    ...
    private static final double STEERING_ANGLE_LOWER_BOUND = Math.toRadians(-20);
    private static final double STEERING_ANGLE_UPPER_BOUND = Math.toRadians(20);
    private static final double STEERING_ANGLE_INCREMENT = Math.toRadians(1);
